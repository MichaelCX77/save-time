  ...
  private void initialize() {
    ...
    this.btnFinalizarTudo.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (!TesteView.this.txtPaginaAtualFinalizar.getText().matches("[0-9]") || TesteView.this.txtPaginaAtualFinalizar.getText().equals("")) {
    ...
    this.btnProximo.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (TesteView.this.txtNomeLivro.getText().equals("") && TesteView.comboMeusLivros.getSelectedItem().equals("Selecione...")) {
              TesteView.this.lblMensagem.setText("*Informe o Livro");
              TesteView.this.lblMensagem.setVisible(true);
            } else if (!TesteView.this.txtTotalPaginas.getText().matches("[0-9]*") || TesteView.this.txtTotalPaginas.getText().equals("")) {
    ...
    table.setModel(new DefaultTableModel(
          new Object[][] { { null, null, null, "teste" }, new Object[6], 
            new Object[6] }, (Object[])new String[] { "Livro", "Total de P\u00E1ginas", "P\u00E1gina Atual", "Data", "Tempo Gasto", "Conclus\u00E3o" }) {
