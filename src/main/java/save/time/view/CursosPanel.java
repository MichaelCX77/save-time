...
public class CursosPanel {
  ...
  public static void carregarCursos() {
    ...
    table.setModel(new DefaultTableModel(CursosPanelController.carregaTable(), 
          (Object[])new String[] { "Data", "Tempo Dedicado", "Nome Curso", "Total de Aulas", "Aula Atual", "Conclus\u00E3o" }) {
    ...
    btnFinalizarTudo.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (!CursosPanel.txtAulaAtualFinalizar.getText().matches("[0-9]*") || CursosPanel.txtAulaAtualFinalizar.getText().equals("")) {
              CursosPanel.lblMensagemFinalizar.setText("*Verifique aula atual");
              CursosPanel.lblMensagemFinalizar.setVisible(true);
            } else if (Integer.parseInt(CursosPanel.txtTotalAulasFinalizar.getText()) < Integer.parseInt(CursosPanel.txtAulaAtualFinalizar.getText())) {
              CursosPanel.lblMensagemFinalizar.setText("*Verifique aula atual");
              CursosPanel.lblMensagemFinalizar.setVisible(true);
            } else {
              Cursos curso = CursosPanelController.verificaCursoMaisRecente(UserSession.getUser().getId(), CursosPanel.txtNomeCursoFinalizar.getText());
    ...
    comboMeusCursos.addItemListener(new ItemListener() {
          public void itemStateChanged(ItemEvent e) {
            if (e.getItem().toString().equals("Selecione...")) {
              ...
              Cursos curso = CursosPanelController.verificaCursoMaisRecente(UserSession.getUser().getId(), e.getItem().toString());
  ...
  public static void actionProximo(ActionEvent e) {
    if (txtNomeCurso.getText().equals("") && comboMeusCursos.getSelectedItem().equals("Selecione...")) {
      ...
      String curso = CursosPanelController.verificaCursoString(UserSession.getUser().getId(), txtNomeCurso.getText());
      if (!curso.equals("")) {
        lblMensagem.setText("*Voc\u00EA j\u00E1 cadastrou esse curso!");
        lblMensagem.setVisible(true);
      } else {
        boolean cursoFinalizado = false;
        if (!txtAulaAtualForm.getText().equals("") && !txtTotalAulasForm.getText().equals("") && 
          Integer.parseInt(txtAulaAtualForm.getText()) == Integer.parseInt(txtTotalAulasForm.getText()))
