...
public class EspiritualPanel {
  ...
  public static void carregarEspiritual() {
    ...
    rdbtnAtividadeExistente.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (EspiritualPanel.rdbtnAtividadeExistente.isSelected() && EspiritualPanel.rdbtnNovaAtividade.isSelected()) {
    ...
    rdbtnNovaAtividade.addActionListener(new ActionListener() {
          public void actionPerformed(ActionEvent e) {
            if (EspiritualPanel.rdbtnNovaAtividade.isSelected() && EspiritualPanel.rdbtnAtividadeExistente.isSelected()) {
  ...
  public static void actionProximo(ActionEvent e) {
    if (txtNomeAtividade.getText().equals("") && comboMinhasAtividades.getSelectedItem().equals("Selecione...")) {
      ...
      String livro = EspiritualPanelController.verificaAtividadeString(UserSession.getUser().getId(), txtNomeAtividade.getText());
      if (!livro.equals("")) {
